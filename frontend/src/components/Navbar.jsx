...
function Navbar() {
  ...
  return (
    <header className="border-b-2 border-base-300 fixed w-full top-0 z-40 backdrop-blur-lg bg-base-100/80">
      <div className="container mx-auto px-4 h-16">
        <div className="flex items-center justify-between h-full">
          ...
          <div className="flex items-center gap-2">
            <Link
              to="/settings"
              className="btn btn-info btn-sm gap-2 transition-colors"
            >
